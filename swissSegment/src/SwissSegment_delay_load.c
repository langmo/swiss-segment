 ...
 */
FARPROC WINAPI SwissSegmentDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = SwissSegmentDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = SwissSegmentDelayLoadWin32FailureHook;
#endif
